...
| :-------------- | :-----------------| :-----------------| :----------------------------| 
|gee | t-test | Wald test |containment or residual; Only applicable for single DF tests|
...
|nbmm_agq| LRT or Wald test | LRT or Wald test| Not applicable |
|nbmm_lp| t-test | LRT | containment or residual; Only applicable for single DF tests |
|nbmm_pl| t-test | F-tesst | containment, residual, ,Kenward-Roger or Satterthwaite; For multiple DF tests only Kenward-Roger or Satterthwaite |
...
| Option               | Description                                         | Default |
| :---------------------- | :--------------------------------------------------- | :----------------|
|corrSeq_results_reduced | Results object from corrSeq_fit containing reduced models for LRT tests. Only applicable for ```nbmm_agq``` models or when using multi-row contrasts (matrix) for nbmm_lp models. |
