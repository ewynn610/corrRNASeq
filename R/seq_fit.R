...
#'
#' @param formula A one-sided linear formula describing both the fixed-effects and random-effects parts of the model using the syntax of the lme4 package
...
#'
#' ##  Fit the Model
#' fit.lmerSeq <- lmerSeq.fit(formula = ~ group * time + (1|ids),
#'                            expr_mat = vst_expr,
